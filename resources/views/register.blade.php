 ...
 <!doctype html>
     ...
     <!-- Login Div -->
        ...
        <div class="moving_size" style="height: 475px;">
         ...
         <p style="font-size: 40px; margin-left: 225px; ">REGISTER</p>

          <form  action="" method="" id="register_form" style="margin-top: 20px; margin-left: 40px;  ">
                    <input class="form_box" type="email" name="email" placeholder="Email ID" required><br><br>
           ...
           <a href= "" ><button type="submit" class="button" style="vertical-align:middle; width: 140px; font-family:'Yrsa', serif; font-size: 25px; margin-left: 200px; "><span>REGISTER </span></button></a>
         </div>
         </div>
